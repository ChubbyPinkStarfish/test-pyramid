...
class FluxTextEncoderWithMask(nn.Module):
    ...
    def _get_t5_prompt_embeds(
        ...
        prompt_embeds = self.text_encoder_2(text_input_ids.to(device), attention_mask=prompt_attention_mask,
    ...
    def forward(self, input_prompts, device):
        with torch.no_grad():
            prompt_embeds, prompt_attention_mask, pooled_prompt_embeds = self.encode_prompt(input_prompts, 1,
                                                                                            device=device)
